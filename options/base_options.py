...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dif_data_augm', type=str, default='translation', help='differential data augmentation currenly only for pix2pix models. [color | translation | cutout | color,cutout|...|color,translation,cutout]')
