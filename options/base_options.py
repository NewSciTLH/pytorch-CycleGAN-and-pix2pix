...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/home/ericd/image_colorization/fourwmask/AB',  help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='pix43wmask', help='name of the experiment. It decides where to store samples and models')
